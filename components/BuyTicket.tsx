...
export default function BuyTicket(item: IProduct) {
  return (
    <div className="relative w-full rounded-2xl bg-white p-2 pb-5 shadow-lg">
      ...
      <div className="mt-5 flex justify-between px-1">
        ...
        <div className="space-y-2">
          <div>
            <span className="text-sm text-gray-400 ml-16">Travel Time : </span>
            <span className="text-green-700">{item.time} min</span>
          </div>
          <div>
            <span className="text-sm text-gray-400 ml-16">Departure On : </span>
            <span className="text-green-700">{item.departure} mint</span>
          </div>
          <div>
            <span className="text-sm text-gray-400 ml-16">Price : </span>
            <span className="text-3xl font-bold text-green-500">
              ${item.price}
            </span>
          </div>
          <div className="flex justify-end pt-4">
            <button className="w-full rounded-full bg-[#9a7fde] py-2 font-bold text-white mb-6">
              BUY TICKET
            </button>
          </div>
        </div>
